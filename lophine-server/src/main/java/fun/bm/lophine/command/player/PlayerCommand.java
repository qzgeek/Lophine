    ...
    private static int showHelp(CommandContext<CommandSourceStack> ctx, int page) {
        Component[][] pages = {
            { Component.text("=== /bot 假人帮助 (1/3) ===", NamedTextColor.GOLD),
                ...
                Component.text("\nattack/use/break <名字> [continuous]"),
                Component.text("\njump/drop/swapHands/mount/dismount <名字>"),
                Component.text("\nstop <名字> — 停止所有动作"),
                Component.text("\nactionstop <名字> <动作> — 停止指定动作"),
            },
            { Component.text("=== /bot 假人帮助 (2/3) ===", NamedTextColor.GOLD),
                Component.text("\n", NamedTextColor.WHITE),
                Component.text("\n§6§l视角与移动", NamedTextColor.GOLD),
                Component.text("\nlook <名字> north/south/east/west/up/down"),
                Component.text("\nlook <名字> at <坐标> — 看向坐标"),
                Component.text("\nturn <名字> left/right/back — 转向"),
                Component.text("\nmove <名字> forward/backward/left/right"),
                Component.text("\n", NamedTextColor.WHITE),
                Component.text("\n§6§l经验（只存点数，等级实时推算）", NamedTextColor.GOLD),
                Component.text("\nxp <名字> take <点数> — 取经验点数"),
                Component.text("\nxp <名字> level <等级> — 取经验等级"),
                Component.text("\nxp <名字> give <点数> — 给假人经验点"),
                Component.text("\nxp <名字> level give <等级> — 给假人经验等级"),
                Component.text("\n", NamedTextColor.WHITE),
